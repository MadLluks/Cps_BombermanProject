...
public abstract class AbstractTest {
	...
	public void testPreInit1() {
		try {
			...
			System.err.println("Message d'erreur relev� !!");
		}
	}
	...
	public void testInvariant() {
		...
		//oracle
		Assert.assertTrue("pasJeu n�gatif", getMoteurJeu().getPasJeuCourant() >= 0);
		Assert.assertTrue("pasJeu sup�rieur � maxPasJeu", getMoteurJeu().getPasJeuCourant() <= getMoteurJeu().getMaxPasJeu());
	}
